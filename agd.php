...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Branch) && empty($Address) && empty($Address) && empty($Latitude) && empty($Longitude)) {
        ...
        global $connection;
        $Query = "INSERT INTO agd(name,address,division,lat,lon) VALUES('$Branch','$Address','$Division','$Latitude','$Longitude')";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                        ...
                        <li><a href="cb.php"><span class="glyphicon glyphicon-tags"></span>
                                &nbsp;CB</a></li>
                        <li class="active"><a href="agd.php"> <span class="glyphicon glyphicon-user"></span>
                                &nbsp;AGD</a></li>
                ...
                <div class="col-sm-10">
                    ...
                    <!-- Input Form Area --> 
                    <div>
                        <form action="agd.php" method="post"> 
                            <fieldset>
                                <!-- Branch Input Field -->
