...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Branch) && empty($Address) && empty($Address) && empty($Latitude) && empty($Longitude)) {
        ...
        global $connection;
        $Query = "INSERT INTO uab(name,address,division,lat,lon) VALUES('$Branch','$Address','$Division','$Latitude','$Longitude')";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                        ...
                        <li><a href="agd.php"> <span class="glyphicon glyphicon-user"></span>
                                &nbsp;AGD</a></li>
                        <li class="active"><a href="uab.php"><span class="glyphicon glyphicon-comment"></span>
                                &nbsp;UAB</a></li>
                ...
                <div class="col-sm-10">
                    ...
                    <!-- Input Form Area --> 
                    <div>
                        <form action="uab.php" method="post"> 
                            <fieldset>
                                <!-- Branch Input Field -->
