...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Branch) && empty($Address) && empty($Address) && empty($Latitude) && empty($Longitude)) {
        ...
        global $connection;
        $Query = "INSERT INTO aya(name,address,division,lat,lon) VALUES('$Branch','$Address','$Division','$Latitude','$Longitude')";
                ...
                <div class="col-sm-2">
                    ...
                    <ul id="Side_Menu" class="nav nav-pills nav-stacked">
                        <li><a href="kbz.php">
                                ...
                                &nbsp;KBZ</a></li>
                        <li class="active"><a href="aya.php"> <span class="glyphicon glyphicon-list-alt"></span>
                                &nbsp;AYA</a></li>               
